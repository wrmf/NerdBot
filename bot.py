	...
	async def on_message(self, msg: discord.Message):
		...
		if msg.guild.me in msg.mentions:
			if ctx.message.author.id == TNMN:
				pass
			elif (ctx.message.author.id == Cheese or ctx.message.author.id == 1128849724401799169 or ctx.message.author.id == 606394564013719573 or ctx.message.author.id == 852913539705602108) and ctx.channel.id in [710542883375022160, 829711652382441503, 901267588041044059]:
